            ...
            partial_build_spec=aws_codebuild_.BuildSpec.from_object({
                ...
                "phases": {
                    ...
                    "pre_build": {
                        "commands": [
                        	"cd pyresttest/",
                            f"echo Printing API URL https://gv56lhvksi.execute-api.us-east-2.amazonaws.com",
                            f"docker build -t pyresttest --build-arg url=https://gv56lhvksi.execute-api.us-east-2.amazonaws.com --build-arg file=rest_api_functional_test.yml ."
                        ]
                    },
                    "build": {
                        "commands": [
